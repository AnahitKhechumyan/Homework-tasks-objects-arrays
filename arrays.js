...
//     },
//   ];
//  function sortedUserByFirstName(){
//     let res = userSorted.sort((a, b) => {
//      return  a.name.first.localeCompare(b.name.first);
//     });
//     console.log(res);
// };
//  sortedUserByFirstName(userSorted);
...
//     },
//   ];
//   function culcTotalSalary(){
//     let total = 0;
//     for(let person  of customersSalary){
//         total += parseFloat(person.salary);
//     };
//     return total;
//   }; 
//   console.log(culcTotalSalary(customersSalary));//601645.8391999999 
...
//     },
//    ];
//   function userFilterByCountOfFriends(){
//     return filterUser.filter(user => user.friends.length < 8);
//   };
//   console.log(userFilterByCountOfFriends(filterUser));
//------or---------
//   function userFilterByCountOfFriends(){  
//     let usersFilterByFriendsLess8 = [];
//     for(let i = 0; i < filterUser.length; i++){
//         if(filterUser[i].friends.length < 8){
//             usersFilterByFriendsLess8.push(filterUser[i]);
//         }
//     };
//     return  usersFilterByFriendsLess8;
//   }
//   console.log(userFilterByCountOfFriends(filterUser));
...
//------եթե քարտեզագրելը նկատի ունի զանգվածով------------------------------------
//   function mappedAllUsersFriends(){
//     return  mappedUsers.map(user => user.friends.map(friend => friend.name));
//   };
//  console.log(mappedAllUsersFriends(mappedUsers));  

// ---------եթե պետք է ցույց տալ բոլոր ընկերների անունները առանց զանգվածի-----------  
// function mappedAllUsersFriends(){
...
//    return;
// };
// mappedAllUsersFriends(mappedUsers);//83 friends
...
//     return mappedUsers.map(user => ({_id: user._id, name: user.name, isActive: user.isActive}));
// };
//   console.log(createNewArray(mappedUsers));